...
extern PROTOBUF_INTERNAL_EXPORT_greeter_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Vector_greeter_2eproto;
namespace calculus {
...
static void InitDefaultsscc_info_Scalar_greeter_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Scalar_greeter_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Scalar_greeter_2eproto}, {}};

static void InitDefaultsscc_info_Vector_greeter_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Vector_greeter_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Vector_greeter_2eproto}, {}};

static void InitDefaultsscc_info_VectorRequest_greeter_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_VectorRequest_greeter_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_VectorRequest_greeter_2eproto}, {
      &scc_info_Vector_greeter_2eproto.base,}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_greeter_2eproto[3];
...
const char descriptor_table_protodef_greeter_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rgreeter.proto\022\010calculus\"\027\n\006Scalar\022\r\n\005v"
  "alue\030\001 \001(\001\")\n\006Vector\022\t\n\001x\030\001 \001(\001\022\t\n\001y\030\002 \001"
  "(\001\022\t\n\001z\030\003 \001(\001\"t\n\rVectorRequest\022\037\n\005first\030"
  "\001 \001(\0132\020.calculus.Vector\022 \n\006second\030\002 \001(\0132"
  "\020.calculus.Vector\022 \n\006thrird\030\003 \001(\0132\020.calc"
  "ulus.Vector2O\n\020VectorCalculator\022;\n\014Cross"
  "Product\022\027.calculus.VectorRequest\032\020.calcu"
  "lus.Vector\"\000b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_greeter_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_greeter_2eproto_sccs[3] = {
  &scc_info_Scalar_greeter_2eproto.base,
  &scc_info_Vector_greeter_2eproto.base,
  &scc_info_VectorRequest_greeter_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_greeter_2eproto = {
  false, false, descriptor_table_protodef_greeter_2eproto, "greeter.proto", 300,
  &descriptor_table_greeter_2eproto_once, descriptor_table_greeter_2eproto_sccs, descriptor_table_greeter_2eproto_deps, 3, 0,
  schemas, file_default_instances, TableStruct_greeter_2eproto::offsets,
  file_level_metadata_greeter_2eproto, 3, file_level_enum_descriptors_greeter_2eproto, file_level_service_descriptors_greeter_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_greeter_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_greeter_2eproto)), true);
namespace calculus {
...
const Scalar& Scalar::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Scalar_greeter_2eproto.base);
...
const Vector& Vector::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Vector_greeter_2eproto.base);
  return *internal_default_instance();
}
...
void VectorRequest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_VectorRequest_greeter_2eproto.base);
